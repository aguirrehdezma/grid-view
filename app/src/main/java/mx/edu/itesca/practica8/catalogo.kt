...
class catalogo : AppCompatActivity() {
    ...
    var asientosSeleccionados = ArrayList<Cliente>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (bundle != null) {
            asientosSeleccionados = bundle.getSerializable("asientos") as ArrayList<Cliente>
            val nombrePelicula = bundle.getString("name")

            val peliculaSeleccionada = peliculas.find { it.titulo == nombrePelicula }
            peliculaSeleccionada?.seats = asientosSeleccionados
    ...
    class PeliculaAdapter : BaseAdapter {
        ...
        override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
            ...
            image.setOnClickListener {
                ...
                val reservedCount = Reservacion.getReservations(pelicula.titulo).size
                intento.putExtra("numberSeats", (20 - reservedCount))
